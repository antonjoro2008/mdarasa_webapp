<div class="mt-12 card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-5"><span class="title-color">Topic Name</span></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3"> {{ $courseUnitTopic->courseUnitName }} </div>
        ...
        <div class="row" style="background:#303030;">
            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form method="get" action="{{ url('/admin/subtopic/notes') }}" class="inline-view pull-right">
                            @csrf
                        ...
                        <form method="get" action="{{ url('/admin/subtopic/content') }}"
