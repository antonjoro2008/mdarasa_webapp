    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2">
                ...
                <form method="get" action="{{ url('/lecturer/topic/content') }}" class="inline-view">
                    @csrf
                    ...
                    <input type="hidden" name="topicVideo" value="{{ $previousTopic->topicVideo }}" />
            ...
            <div class="col-md-2">
                ...
                <form method="get" action="{{ url('/lecturer/topic/content') }}" class="inline-view">
                    ...
                    <input type="hidden" name="topicVideo" value="{{ $nextTopic->topicVideo }}" />
        ...
        <div class="row">
            <div class="col-md-9 mt-12">
                <div class="center-flex">
                    ...
                    <video width="95%" height="500" controls="controls">
                        <source src="{{ $serverUrl }}/topic/download/{{ $topicVideo }}">
                        Your browser does not support this video file format. Please
                ...
                <div class="row mt-12">
                    ...
                    @if(!is_null($subtopic->subtopicVideo))
                    <div class="col-sm-3 flex">
                        <div>
                            <form method="get" action="{{ url('/lecturer/subtopic/content') }}" class="inline-view">
                                ...
                                <input type="hidden" name="subtopicVideo" value="{{ $subtopic->subtopicVideo }}" />
                                <button type="submit" class="related-topic-btn flex pt-8"
            ...
            <div class="col-md-3 mt-12">
                <div class="title-color">Related Topic Videos</div>
                ...
                <div class="mt-12 flex">
                    ...
                    <div class="full-width">
                        <form method="get" action="{{ url('/lecturer/topic/content') }}" class="inline-view">
                            ...
                            <input type="hidden" name="topicVideo" value="{{ $topic->topicVideo }}" />
