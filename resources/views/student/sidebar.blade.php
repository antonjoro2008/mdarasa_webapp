<div class="sidebar d-none d-sm-block" id="sidebarCats">
    <ul>
        @if(!is_null($categories))
        @foreach($categories as $category)
        <li onmouseenter="loadSubcategories({{ $category->categoryId }})">
            <a class="nav-link" href={{ url('/category/course-units') }}/{{ $category->categoryId }}>
    ...
    <div class="popover-app" id="sidebar-subcats"></div>
    <div class="popover-next" id="sidebar-lecturers"></div>
</div>
